  ...
  <div class="school-feedbacks" v-loading="loading">
      ...
      <el-card shadow="never" class="filter-card">
        <el-form :inline="true" :model="filters" class="filter-form">
          ...
          <el-form-item>
            ...
            <el-button type="warning" :loading="aiAnalyzing" @click="runAiAnalysis">{{ $t("🤖 AI分析") }}</el-button>
    ...
    >
          ...
          <el-form-item label="附件">
            ...
            >
              <el-button type="primary" size="small" plain>
                <el-icon style="margin-right: 4px"><Upload /></el-icon>{{ $t("上传附件") }}</el-button>
              <template #tip>
      ...
      <template #footer>
        ...
        <el-button type="primary" :loading="replySubmitting" @click="submitReply">{{ $t("确认回复") }}</el-button>
      </template>
    </el-dialog>
  </div>
</template>
