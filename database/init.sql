...
CREATE TABLE IF NOT EXISTS activity (
    ...
    category VARCHAR(30) COMMENT '活动分类: 宣讲会/开放日/夏令营/咨询会/回访母校/线上直播/走访宣讲/招生宣传/其他',
    level VARCHAR(10) COMMENT '院级/校级',
    ...
    college_id BIGINT COMMENT '归属学院ID',
    college_name VARCHAR(100) COMMENT '归属学院名称',
    create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
    update_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS policy (
    ...
    type VARCHAR(20) DEFAULT '章程' COMMENT '章程/简章/通知/办法/数据',
...
-- ============================================================
-- 招生政策数据 (来源: 新疆大学迎新网 welcome.xju.edu.cn)
-- ============================================================
INSERT INTO policy (title, content, type) VALUES
('新疆大学2026年普通本科招生章程', '## 第一章 总则\n\n第一条 为保证新疆大学本科招生工作顺利进行，规范招生行为，切实维护考生合法权益，根据《中华人民共和国教育法》《中华人民共和国高等教育法》等相关法律和教育部有关规定，结合新疆大学本科招生工作实际，特制定本章程。\n\n第二条 学校名称：新疆大学（XINJIANG UNIVERSITY）。国标代码：10755。\n\n第三条 新疆大学是全国重点大学，国家"双一流"建设高校，国家"211工程"重点建设高校。\n\n## 第二章 招生计划\n\n第四条 2026年学校计划招收本科生约7500人。\n\n## 第三章 录取规则\n\n第五条 按照"分数优先，遵循志愿"原则进行专业录取，无专业志愿级差。\n\n第六条 英语专业要求英语单科成绩不低于110分。软件工程、数学等理工专业要求数学不低于90分。', '章程'),
('新疆大学2025年普通本科招生章程', '## 第一章 总则\n\n第一条 根据《中华人民共和国教育法》《中华人民共和国高等教育法》等相关法律和教育部有关规定，制定本章程。\n\n第二条 学校名称：新疆大学。国标代码：10755。\n\n## 第二章 招生计划\n\n第三条 2025年计划招收本科生约7200人。\n\n## 第三章 录取规则\n\n第四条 按照"分数优先，遵循志愿"原则录取，无专业志愿级差。英语专业要求英语≥110分。', '章程'),
('新疆大学2025年国家专项计划招生通知', '## 国家专项计划\n\n面向新疆及中西部地区脱贫县、乡村振兴重点帮扶县的高中毕业生。\n\n### 报名条件\n本人具有实施区域连续3年以上户籍，具有户籍所在县高中连续3年学籍并实际就读。\n\n### 招生专业\n计算机科学与技术、软件工程、电子信息工程、数学与应用数学等。', '通知'),
('新疆大学2025年艺术类专业招生简章', '## 招生专业\n音乐表演（声乐、器乐）、舞蹈表演、美术学、设计学类。\n\n### 报考条件\n符合高考报名条件，参加省统考且成绩合格。\n\n### 录取规则\n文化课和统考成绩均达线后，按统考成绩从高到低录取。学费8000元/年。', '简章');
