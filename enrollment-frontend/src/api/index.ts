...
export const approvalApi = {
  ...
  statsCollege: (params?: any) => request.get('/approval/stats/college', { params }),
  statsSchool: (params?: any) => request.get('/approval/stats/school', { params }),
...
export const aiApi = {
  ...
  analyzeFeedbackAll: (contents: string[]) => request.post('/ai/feedback/analyze-all', { contents }),
